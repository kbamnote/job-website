...
const MyJobs = () => {
 ...
 <main className="lg:w-3/4 w-full ml-auto p-8">
 ...
 className="bg-white text-teal-600 px-8 py-3 rounded-lg border border-teal-600 hover:bg-teal-50 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {loadingMore ? (
