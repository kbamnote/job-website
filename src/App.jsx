      ...
      <BrowserRouter>
        <Routes>
         ...
         <Route path="/profile-hoster" element={<HostingProfileDetail />} />
          ...
          <Route path="/ai-resume-builder" element={<ProtectedRoute><AiResume /></ProtectedRoute>} />
          <Route path="/ats-score-checker" element={<ProtectedRoute><AtsScore /></ProtectedRoute>} />
